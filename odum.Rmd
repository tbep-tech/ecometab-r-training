...
where metabolism is an areal rate, gas exchange is estimated as the gas transfer velocity $k_{0_2}$ multiplied by the difference between the air-sea oxygen gradient, and the effect of the tide on the dissolved oxygen gradient in two later dimensions.  
